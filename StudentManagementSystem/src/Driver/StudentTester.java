...
import static com.app.ValidateStudentAllDetails.*;
			...
			while(!exit)
			{
				try {
					...
					System.out.println("1.Register new student , 2. Display students"
							+ "3. Remove if fee not submitted,  4. Display student name from specific city"
							+ "5. sort by dob, 6.display email of student fee less than 70000");
					System.out.println("Enter a choice");
					switch(sc.nextInt())
					{
					case 1:
						Student s = validateAll(sc.next(),sc.next(),sc.next(),sc.next(),sc.next(),sc.next(),sc.next(),sc.next(),sc.nextDouble(),sc.nextBoolean(),studmap);
						studmap.put(s.getRollno(), s);
						System.out.println("Student added");
						//System.out.println("Enter file name  ");
						storeDetails(filename,studmap);
...
//							}
					...
					case 7:
						...
						Map<String, Student> maps =restoreDetails(filename);
